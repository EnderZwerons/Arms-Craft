namespace UnityEngine.Advertisements
{
	internal class UnityAdsAndroid : UnityAdsPlatform
	{
		...
		public override bool show(string zoneId, string rewardItemKey, string options)
		{
			...
			return false;//return getAndroidWrapper().Call<bool>("show", new object[3] { zoneId, rewardItemKey, options });
		}
		...
		public override bool isSupported()
		{
			...
			return false;//return getAndroidWrapper().Call<bool>("isSupported", new object[0]);
		}

		public override string getSDKVersion()
		{
			//Utils.LogDebug("UnityAndroid: getSDKVersion()");
			return "";//return getAndroidWrapper().Call<string>("getSDKVersion", new object[0]);
		}

		public override bool canShowZone(string zone)
		{
			return false;//return getAndroidWrapper().Call<bool>("canShowZone", new object[1] { zone });
		}

		public override bool hasMultipleRewardItems()
		{
			//Utils.LogDebug("UnityAndroid: hasMultipleRewardItems()");
			return false;//return getAndroidWrapper().Call<bool>("hasMultipleRewardItems", new object[0]);
		}

		public override string getRewardItemKeys()
		{
			//Utils.LogDebug("UnityAndroid: getRewardItemKeys()");
			return "";//return getAndroidWrapper().Call<string>("getRewardItemKeys", new object[0]);
		}

		public override string getDefaultRewardItemKey()
		{
			//Utils.LogDebug("UnityAndroid: getDefaultRewardItemKey()");
			return "";//return getAndroidWrapper().Call<string>("getDefaultRewardItemKey", new object[0]);
		}

		public override string getCurrentRewardItemKey()
		{
			//Utils.LogDebug("UnityAndroid: getCurrentRewardItemKey()");
			return "";//return getAndroidWrapper().Call<string>("getCurrentRewardItemKey", new object[0]);
		}
		...
		public override bool setRewardItemKey(string rewardItemKey)
		{
			...
			return false;//return getAndroidWrapper().Call<bool>("setRewardItemKey", new object[1] { rewardItemKey });
		}
		...
		public override string getRewardItemDetailsWithKey(string rewardItemKey)
		{
			...
			return "";//return getAndroidWrapper().Call<string>("getRewardItemDetailsWithKey", new object[1] { rewardItemKey });
		}

		public override string getRewardItemDetailsKeys()
		{
			//Utils.LogDebug("UnityAndroid: getRewardItemDetailsKeys()");
			return "";//return getAndroidWrapper().Call<string>("getRewardItemDetailsKeys", new object[0]);
		}
